...
<div> 
  ...
  <div class="p-3 mb-2 bg-secondary text-white">
    <center>
      <h4><b>PENGATURAN MENU</b></h4>
      </center>
      <form action="" method="get">
	      <input type="text" class="btn bg-light" name="kata_cari" placeholder="Search.." value="<?php if(isset($_GET['kata_cari'])) { echo $_GET['kata_cari']; } ?>"  />
	      <button type="submit" class="btn btn-primary"><i class="bi bi-search"></i></button>
          <a href='tambah_menu.php' class="btn btn-success btn-xm">Tambah Menu</a>
      </form>
    </div>
  <div class="container p-3 mb-2 bg-light text-dark">
	...
	<ul class="sci">
        ...
        <a href='edit_menu.php?id="<?= $row['id'] ?>"' class="btn btn-primary btn-xm bi bi-pen"></a>
        <a href='delete_menu.php?id="<?= $row['id'] ?>"' class="btn btn-danger btn-xm bi bi-trash"></a>
      </form>
    </li>
	</ul>
</div>
