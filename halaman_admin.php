...
<style>
  .jumbotron {
	background-image: url("https://previews.123rf.com/images/jakkapan/jakkapan1801/jakkapan180100122/94133675-blurred-background-image-of-coffee-shop-abstract-blur-background-with-people-in-cafe-vintage-color-t.jpg");
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="well">
          ...
          <hr>
          <p class="lead font-weight-bold" style="color:white;">Anda Masuk sebagai Admin</p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  <!-- Sidebar -->
